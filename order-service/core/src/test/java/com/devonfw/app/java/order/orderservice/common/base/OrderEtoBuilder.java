...
public final class OrderEtoBuilder {
  ...
  public OrderEto build() {
    ...
    orderEto.setPrice(this.price);
    orderEto.setStatus(this.status);
    orderEto.setCreationDate(this.creationDate);
    orderEto.setOwnerId(this.ownerId);
    orderEto.setId(this.id);
    orderEto.setModificationCounter(this.modificationCounter);
    return orderEto;
  }
}