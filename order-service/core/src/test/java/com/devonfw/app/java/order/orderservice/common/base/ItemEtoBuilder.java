...
public final class ItemEtoBuilder {
  ...
  public ItemEto build() {
    ...
    itemEto.setName(this.name);
    itemEto.setDescription(this.description);
    itemEto.setPrice(this.price);
    itemEto.setId(this.id);
    itemEto.setModificationCounter(this.modificationCounter);
    return itemEto;
  }
}