...
public interface ItemTestData {
   ...
   * The constant CHEESE.
   */
  ItemEtoBuilder CHEESE = ItemEtoBuilder.anItemEto().withName("cheese").withPrice(12.50);

  /**
   * The constant CORN.
   */
  ItemEtoBuilder CORN = ItemEtoBuilder.anItemEto().withName("corn").withPrice(5.50);
