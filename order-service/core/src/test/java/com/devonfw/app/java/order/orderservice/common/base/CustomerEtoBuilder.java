...
public final class CustomerEtoBuilder {
  ...
  public CustomerEto build() {
    ...
    customerEto.setFirstname(this.firstname);
    customerEto.setLastname(this.lastname);
    customerEto.setId(this.id);
    customerEto.setModificationCounter(this.modificationCounter);
    return customerEto;
  }
}